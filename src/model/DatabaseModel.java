...
public class DatabaseModel {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/Gossip?useUnicode=true&characterEncoding=utf-8&useSSL=false";
     ...
     */
    public static boolean[] myGetInt(String condition, int n) {
    ...
    public ResultSet select(String option, String tableName, String condition, String... data) throws SQLException {
        ...
        flag = myGetInt(condition, data.length);
        preparedStatement = connection.prepareStatement(Sql);
        for (int i = 1; i <= data.length; i++) {
            if (flag[i - 1]) {
